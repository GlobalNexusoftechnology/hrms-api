...
export class CreateRoleTable1779388143170 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."employees_employment_type_enum" AS ENUM('FULL_TIME', 'PART_TIME', 'INTERN', 'CONTRACT')`);
        await queryRunner.query(`ALTER TABLE "employees" ADD "employment_type" "public"."employees_employment_type_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."employees_gender_enum" AS ENUM('MALE', 'FEMALE', 'OTHER')`);
        await queryRunner.query(`ALTER TABLE "employees" ADD "gender" "public"."employees_gender_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "employees" DROP COLUMN "employment_type"`);
