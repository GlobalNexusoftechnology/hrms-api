...
export class CreateRoleTable1779476128871 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."leaves_type_enum" AS ENUM('CASUAL', 'SICK', 'PAID', 'UNPAID', 'EMERGENCY', 'MATERNITY', 'PATERNITY')`);
        ...
        await queryRunner.query(`ALTER TABLE "leaves" ADD CONSTRAINT "FK_b210cc3d4ac04227754ff647d3b" FOREIGN KEY ("reviewed_by_id") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "leaves" DROP CONSTRAINT "FK_b210cc3d4ac04227754ff647d3b"`);
